...
public class Criteria {
    ...
    public Criteria(int ageRange, String qualifications, int workingYears, String occupations, boolean healthRecords, boolean criminalRecords, String computerSkills, String languageSpoken) {
    ...
    public void setAgeRange(int ageRange, int range) {
        this.ageRange = ageRange;
    }
